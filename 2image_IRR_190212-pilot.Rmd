...
data <- data %>%
  mutate(c1_humans.v1 = ifelse(r1_humans.v1 == paste0(levels(data$r1_humans.v1)[2]), 1, 0))
...
temp <- data %>%
  mutate(c1_humans.v2 = ifelse(r1_humans.v2 == "", 99,
                               ifelse(r1_humans.v2 == 
paste0(levels(data$r1_humans.v2)[4]), 1, 0)))
# Test it
...
temp <- data %>%
  mutate(c1_nonwh = ifelse(r1_nonwh == "", 99,
                           ifelse(r1_nonwh == paste0(levels(data$r1_nonwh)[4]), 1, 0)))
# Test it
...
temp <- data %>%
  mutate(c1_nonmale = ifelse(r1_nonmale == "", 99,
                           ifelse(r1_nonmale == paste0(levels(data$r1_nonmale)[4]),1, 0)))
...
temp <- data %>%
  mutate(c1_whmale = ifelse(r1_whmale == "", 99,
                           ifelse(r1_whmale == paste0(levels(data$r1_whmale)[4]), 1, 0)))
...
temp <- data %>%
  mutate(c1_nonwest = ifelse(r1_nonwest == "", 99,
                           ifelse(r1_nonwest == paste0(levels(data$r1_nonwest)[4]), 1, 0)))
...
temp <- data %>%
  mutate(c1_landurban = ifelse(r1_landurban == "", 99,
                           ifelse(r1_landurban == paste0(levels(data$r1_landurban)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_landcult = ifelse(r1_landcult == "", 99,
                           ifelse(r1_landcult == paste0(levels(data$r1_landcult)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_natres = ifelse(r1_natres == "", 99,
                           ifelse(r1_natres == paste0(levels(data$r1_natres)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_ag = ifelse(r1_ag == "", 99,
                           ifelse(r1_ag == paste0(levels(data$r1_ag)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_restore = ifelse(r1_restore == "", 99,
                           ifelse(r1_restore == paste0(levels(data$r1_restore)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_recnoext = ifelse(r1_recnoext == "", 99,
                           ifelse(r1_recnoext == paste0(levels(data$r1_recnoext)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_recext = ifelse(r1_recext == "", 99,
                           ifelse(r1_recext == paste0(levels(data$r1_recext)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_animalnonext = ifelse(r1_animalnonext == "", 99,
                           ifelse(r1_animalnonext == paste0(levels(data$r1_animalnonext)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_animalext = ifelse(r1_animalext == "", 99,
                           ifelse(r1_animalext == paste0(levels(data$r1_animalext)[4]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_logo = ifelse(r1_logo == "", 99,
                           ifelse(r1_logo == paste0(levels(data$r1_logo)[4]), 1, 0))) %>% # sets any present to 1
...
data <- data %>% select(-time,  -notes)


write.csv(data,"rounds4-7_midway.csv")
