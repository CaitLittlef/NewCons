...
data <- read.csv("responses_1raw/split_decision_recodes_190228.csv")
...
temp <- data %>%
  mutate(c1_humans.v2 = ifelse(r1_humans.v2 == "", 99,
                               ifelse(r1_humans.v2 == 
paste0(levels(data$r1_humans.v2)[2]), 1, 0)))
# Test it
temp[,c("r1_humans.v2","c1_humans.v2", "c1_humans.v1")]
...
temp <- data %>%
  mutate(c1_nonwh = ifelse(r1_nonwh == "", 99,
                           ifelse(r1_nonwh == paste0(levels(data$r1_nonwh)[2]), 1, 0)))
# Test it
...
temp <- data %>%
  mutate(c1_nonmale = ifelse(r1_nonmale == "", 99,
                           ifelse(r1_nonmale == paste0(levels(data$r1_nonmale)[2]),1, 0)))
...
temp <- data %>%
  mutate(c1_nonwest = ifelse(r1_nonwest == "", 99,
                           ifelse(r1_nonwest == paste0(levels(data$r1_nonwest)[2]), 1, 0)))
...
temp <- data %>%
  mutate(c1_landurban = ifelse(r1_landurban == "", 0, # there were a few blanks that shoudl have been absent
                           ifelse(r1_landurban == paste0(levels(data$r1_landurban)[2]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_landcult = ifelse(r1_landcult == "", 0,
                           ifelse(r1_landcult == paste0(levels(data$r1_landcult)[2]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_natres = ifelse(r1_natres == "", 0,
                           ifelse(r1_natres == paste0(levels(data$r1_natres)[2]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_ag = ifelse(r1_ag == "", 99,
                           ifelse(r1_ag == paste0(levels(data$r1_ag)[2]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_restore = ifelse(r1_restore == "", 0,
                           ifelse(r1_restore == paste0(levels(data$r1_restore)[2]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_recnoext = ifelse(r1_recnoext == "", 0,
...
temp <- data %>%
  mutate(c1_recext = ifelse(r1_recext == "", 0,
...
temp <- data %>%
  mutate(c1_animalnonext = ifelse(r1_animalnonext == "", 0,
...
temp <- data %>%
  mutate(c1_animalext = ifelse(r1_animalext == "", 99,
                           ifelse(r1_animalext == paste0(levels(data$r1_animalext)[2]), 1, 0))) %>% # sets any present to 1
...
temp <- data %>%
  mutate(c1_logo = ifelse(r1_logo == "", 99,
                           ifelse(r1_logo == paste0(levels(data$r1_logo)[2]), 1, 0))) %>% # sets any present to 1
...
# write.csv(data,"D:/Shared/BackedUp/Caitlin/NewConsDebate/responses_2cleaned/recode_clean.csv")
